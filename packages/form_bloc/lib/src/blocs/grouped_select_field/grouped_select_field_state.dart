...
class GroupedSelectFieldBlocState<Group, Value, ExtraData>
    extends FieldBlocState<Value?, Value, ExtraData?> {
  final Map<Group, List<Value>> items;
  ...
  @override
  GroupedSelectFieldBlocState<Group, Value, ExtraData> copyWith({
    bool? isValueChanged,
