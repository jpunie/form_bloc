...
class GroupedDropdownFieldBlocBuilder<Group, Value> extends StatelessWidget {
  const GroupedDropdownFieldBlocBuilder({
    Key? key,
  ...
  final GroupedSelectFieldBloc<Group, Value, dynamic> selectFieldBloc;
  ...
  final FieldItemBuilder<Group> groupBuilder;
  ...
  final ValueChanged<GroupedDropdownValue?>? onChanged;
  ...
  Widget build(BuildContext context) {
    ...
    return SimpleFieldBlocBuilder(
      ...
      builder: (context, canShow) {
        return BlocBuilder<GroupedSelectFieldBloc<Group, Value, dynamic>,
            GroupedSelectFieldBlocState<Group, Value, dynamic>>(
                  ...
                  child: DropdownButton<dynamic>(
                    ...
                    disabledHint: disabledHint ??
                        (decoration.hintText != null
                            ...
                            : null),
                    onChanged: fieldBlocBuilderOnChange<dynamic>(
                      isEnabled: isEnabled,
  ...
  Widget _buildHeaderTextStyle({
    ...
    return DefaultTextStyle(
      ...
      style: Style.resolveTextStyle(
        isEnabled: false,
        style: fieldTheme.textStyle!.copyWith(
  ...
  List<DropdownMenuItem<dynamic>> _buildItems({
    ...
    required DropdownFieldTheme fieldTheme,
    required Map<Group, List<Value>> items,
    required bool isSelected,
    required bool isEnabled,
  }) {
    ...
    for (var entry in items.entries) {
      dropdownItems.add(_buildGroupHeader(
          context: context, fieldTheme: fieldTheme, group: entry.key));
      for (var entryItem in entry.value) {
        dropdownItems.add(_buildGroupedItem(
            context: context,
            fieldTheme: fieldTheme,
            value: entryItem,
            isEnabled: isEnabled,
  ...
  DropdownMenuItem<dynamic> _buildGroupHeader(
      {required BuildContext context,
      required DropdownFieldTheme fieldTheme,
      required Group group}) {
    final fieldItem = groupBuilder(context, group);

    return DropdownMenuItem<dynamic>(
      value: GroupedDropdownValue(group, null),
      enabled: false,
      alignment: fieldItem.alignment,
      child: _buildHeaderTextStyle(
        fieldTheme: fieldTheme,
  ...
  DropdownMenuItem<Value> _buildGroupedItem({
    required BuildContext context,
    required DropdownFieldTheme fieldTheme,
  ...
  InputDecoration _buildDecoration(
    ...
    GroupedSelectFieldBlocState<Group, Value, dynamic> state,
    bool isEnabled,
  ) {
